package com.zz.common.http.model;
...
public class RequestHeader {
	...
	public static RequestHeader deFault() {
		//
		return null;
	}

	private Map<String, String> headersMap = new ConcurrentHashMap<String, String>();
	 ...
	 * @return 返回当前对象
	 */
	public RequestHeader other(String key, String value) {
	...
	public RequestHeader accept(String accept) {
		headersMap.put(HttpReqHead.ACCEPT, accept);
		return this;
	}
	 ...
	 * @return 返回当前对象
	 */
	public RequestHeader charSet(String acceptCharset) {
		headersMap.put(HttpReqHead.ACCEPT_CHARSET, acceptCharset);
		return this;
	}
	...
	public RequestHeader acceptEncoding(String acceptEncoding) {
		headersMap.put(HttpReqHead.ACCEPT_ENCODING, acceptEncoding);
		return this;
	}
	...
	public RequestHeader acceptLanguage(String acceptLanguage) {
		headersMap.put(HttpReqHead.ACCEPT_LANGUAGE, acceptLanguage);
		return this;
	}
	...
	public RequestHeader acceptRanges(String acceptRanges) {
		headersMap.put(HttpReqHead.ACCEPT_RANGES, acceptRanges);
		return this;
	}
	...
	public RequestHeader authorization(String authorization) {
		headersMap.put(HttpReqHead.AUTHORIZATION, authorization);
		return this;
	}
	...
	public RequestHeader cacheControl(String cacheControl) {
		headersMap.put(HttpReqHead.CACHE_CONTROL, cacheControl);
		return this;
	}

	/**
	 * 表示是否需要持久连接（HTTP 1.1默认进行持久连接） 例如：Connection: close 短链接； Connection: keep-alive
	 * 长连接
	 * 
	 * @param connection
	 *            connection
	...
	public RequestHeader connection(String connection) {
		headersMap.put(HttpReqHead.CONNECTION, connection);
		return this;
	}
	...
	public RequestHeader cookie(String cookie) {
		headersMap.put(HttpReqHead.COOKIE, cookie);
		return this;
	}
	...
	public RequestHeader contentLength(String contentLength) {
		headersMap.put(HttpReqHead.CONTENT_LENGTH, contentLength);
		return this;
	}
	...
	public RequestHeader contentType(String contentType) {
		headersMap.put(HttpReqHead.CONTENT_TYPE, contentType);
		return this;
	}
	...
	public RequestHeader date(String date) {
		headersMap.put(HttpReqHead.DATE, date);
		return this;
	}
	...
	public RequestHeader expect(String expect) {
		headersMap.put(HttpReqHead.EXPECT, expect);
		return this;
	}
	...
	public RequestHeader from(String from) {
		headersMap.put(HttpReqHead.FROM, from);
		return this;
	}
	...
	public RequestHeader host(String host) {
		headersMap.put(HttpReqHead.HOST, host);
		return this;
	}
	...
	public RequestHeader ifMatch(String ifMatch) {
		headersMap.put(HttpReqHead.IF_MATCH, ifMatch);
		return this;
	}
	...
	public RequestHeader ifModifiedSince(String ifModifiedSince) {
		headersMap.put(HttpReqHead.IF_MODIFIED_SINCE, ifModifiedSince);
		return this;
	}
	...
	public RequestHeader ifNoneMatch(String ifNoneMatch) {
		headersMap.put(HttpReqHead.IF_NONE_MATCH, ifNoneMatch);
		return this;
	}
	...
	public RequestHeader ifRange(String ifRange) {
		headersMap.put(HttpReqHead.IF_RANGE, ifRange);
		return this;
	}
	...
	public RequestHeader ifUnmodifiedSince(String ifUnmodifiedSince) {
		headersMap.put(HttpReqHead.IF_UNMODIFIED_SINCE, ifUnmodifiedSince);
		return this;
	}
	...
	public RequestHeader maxForwards(String maxForwards) {
		headersMap.put(HttpReqHead.MAX_FORWARDS, maxForwards);
		return this;
	}
	...
	public RequestHeader pragma(String pragma) {
		headersMap.put(HttpReqHead.PRAGMA, pragma);
		return this;
	}
	...
	public RequestHeader proxyAuthorization(String proxyAuthorization) {
		headersMap.put(HttpReqHead.PROXY_AUTHORIZATION, proxyAuthorization);
		return this;
	}
	...
	public RequestHeader range(String range) {
		headersMap.put(HttpReqHead.RANGE, range);
		return this;
	}
	...
	public RequestHeader referer(String referer) {
		headersMap.put(HttpReqHead.REFERER, referer);
		return this;
	}
	...
	public RequestHeader te(String te) {
		headersMap.put(HttpReqHead.TE, te);
		return this;
	}
	...
	public RequestHeader upgrade(String upgrade) {
		headersMap.put(HttpReqHead.UPGRADE, upgrade);
		return this;
	}
	...
	public RequestHeader userAgent(String userAgent) {
		headersMap.put(HttpReqHead.USER_AGENT, userAgent);
		return this;
	}
	...
	public RequestHeader warning(String warning) {
		headersMap.put(HttpReqHead.WARNING, warning);
		return this;
	}
	...
	public RequestHeader via(String via) {
		headersMap.put(HttpReqHead.VIA, via);
		return this;
	}
	...
	public RequestHeader keepAlive(String keepAlive) {
		headersMap.put(HttpReqHead.KEEP_ALIVE, keepAlive);
		return this;
	}
	...
	private String get(String headName) {
		if (headersMap.containsKey(headName)) {
			return headersMap.get(headName);
		}
		return null;
	}
	...
	public Header[] getHeaders() {
		...
		Header[] headers_tmp = new Header[0];
		Set<String> keys = headersMap.keySet();
		headers_tmp = new BasicHeader[headersMap.size()];
		int i = 0;
		for (String key : keys) {
			Header header = new BasicHeader(key, headersMap.get(key));
			headers_tmp[i++] = header;
		}
		headersMap.clear();
		headersMap = null;
		return headers;
